export const cases = [
    {
      ...
      damages: "$175,000 – $450,000+", risk: "Significant. Primary risk is qualified immunity on both remaining counts: under Wesby and Kisela, Plaintiff must identify precedent 'squarely governing' these specific facts (late-night welfare check, visible cup, DUI escalation) — none cited. Iqbal/Twombly risk: key facts defeating QI (cup had no alcohol, not in plain view; officers fabricated observations) first appeared in the Opposition, not the Complaint, leaving the pleading facially thin. Strategic concessions eliminated Monell and all official-capacity claims, narrowing to individual-capacity Counts I and II only. Leave to amend likely required.",
      evidence: ["CHP arrest report", "Chemical test advisements", "Administrative chemical refusal designation", "Class A CDL suspension record (through February 2026)", "Field sobriety test results", "Rental Tesla Model Y (vehicle)", "Empty container recovered during warrantless search", "DA declination to file charges"],
      documents: []
    },
    {
