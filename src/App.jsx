...
const PORTFOLIO = {
  ...
  cases: [
    ...
    {
      number: 3, caption: "Newanforbi v. Macomber", case_no: "26WM000028", court: "Sacramento Sup. Ct.",
    ...
    {
      number: 4, caption: "Newanforbi v. Derrick et al.", case_no: "2:26-cv-00004-DJC-JDP", court: "USDC E.D. Cal.",
      claims: "42 USC 1983: 1A Retaliation, 14A Equal Protection, Due Process", status: "Active; Ex Parte filed",
      ...
      procedural_status: "Ex Parte Motion filed. FAC filed. Early stages.",
    ...
    {
      number: 5, caption: "Newanforbi v. Derrick et al.", case_no: "TBD", court: "San Joaquin Sup. Ct.",
      claims: "IIED, Bane Act, Intentional/Negligent Econ. Interference, Negligent Supervision, NIED", status: "Gov. Claim deemed rejected; filing imminent",
      filed: "Gov. Claim filed Feb. 2026; deemed rejected ~late Mar. 2026", judge: "TBD", cluster: 2, type: "State",
      ...
      key_facts: "State law parallel to Matter 4. Bane Act claim based on Derrick's speech suppression threats and witness intimidation. Intentional and negligent economic interference: documented FedEx relationship ($20/hr) destroyed. Negligent supervision: Noguchi had actual knowledge of retaliation and failed to intervene. CDCR vicariously liable under §815.2(a). Must file within 6 months of deemed rejection (~Sep. 2026).",
      procedural_status: "Gov. Claim filed Feb. 2026. Deemed rejected by operation of law (~late Mar. 2026). Complaint ready. Must file within 6 months of deemed rejection (Gov. Code §945.6(a)(1)).",
      damages: "$200,000 - $500,000+", risk: "Discretionary immunity argument; ministerial duties exception applies.",
      evidence: ["Same as Matter 4", "Gov. Claim documentation"]
    },
    {
      number: 6, caption: "Newanforbi v. Urrea et al.", case_no: "2:26-cv-00190-DC-SCR", court: "USDC E.D. Cal.",
    ...
    {
      number: 7, caption: "Newanforbi v. HOPE et al.", case_no: "2:26-cv-00195-TLN-AC", court: "USDC E.D. Cal.",
    ...
    {
      number: 8, caption: "Newanforbi v. Palacios et al.", case_no: "STK-CV-UF-2026-0001032", court: "San Joaquin Sup. Ct.",
      claims: "Fraud, Negligence, False Imprisonment, IIED, Econ. Interference", status: "Filed 02/10/2026; SERVICE NEEDED by ~04/11/2026",
      ...
      procedural_status: "Filed 02/10/2026. Fee waiver approved. Summons issued. CMC 10/13/2026. SERVICE DEADLINE: Summons expires ~04/11/2026 (60 days). Must serve HOPE Psychotherapy, Inc. and Katie Palacios.",
    ...
    {
      number: 9, caption: "Ngwa Nforbi v. Diamond Truck Sales", case_no: "STK-CV-UF-2026-0001094", court: "San Joaquin Sup. Ct.",
      claims: "Fraud, Breach of Contract, UCL (B&P 17200), Rescission", status: "Filed 02/13/2026; SERVICE NEEDED by ~04/14/2026",
      ...
      procedural_status: "Filed 02/13/2026. Fee waiver approved. Summons issued. CMC 08/12/2026. SERVICE DEADLINE: Summons expires ~04/14/2026 (60 days). Must serve Diamond Truck Sales Inc. (Texas corp. — may require out-of-state service).",
    ...
    {
      number: 12, caption: "Newanforbi v. Maloney et al.", case_no: "2:26-cv-00194-DAD-SCR", court: "USDC E.D. Cal.",
      claims: "42 USC 1983: Civil Rights", status: "Filed 01/22/2026",
    ...
    {
      number: 13, caption: "Newanforbi v. Barocio", case_no: "2:26-cv-00191-DJC-CSK", court: "USDC E.D. Cal.",
      claims: "42 USC 1983: Civil Rights", status: "Filed 01/22/2026",
    ...
    {
      number: 14, caption: "Newanforbi v. Macomber", case_no: "C2602632", court: "Santa Clara Sup. Ct.",
    ...
    {
      number: 15, caption: "Newanforbi v. Macomber", case_no: "TBD (USDC E.D. Cal.)", court: "USDC E.D. Cal.",
    ...
    {
      number: 16, caption: "Newanforbi v. HOPE Psychotherapy, Inc. et al.", case_no: "TBD (San Joaquin Sup. Ct.)", court: "San Joaquin Sup. Ct.",
      claims: "Bane Act, Prof. Negligence, Negligent Supervision, IIED, Econ. Interference", status: "Filed 03/16/2026",
      filed: "March 16, 2026", judge: "TBD", cluster: 2, type: "State",
      defendants: "Jane Doe (supervised trainee); Katherine A. Palacios, LMFT (individual & supervisory); Nicole Juszczak (supervised trainee); HOPE Psychotherapy, Inc.; DOES 1-25",
      causes: ["Bane Act (Civ. Code §52.1)", "Professional Negligence / Medical Malpractice", "Negligent Supervision", "IIED", "Intentional Interference with Economic Advantage"],
      key_facts: "On Feb. 18, 2026, during a CTM, Defendant Doe — a pre-licensed trainee under Palacios's authority — denied Plaintiff's titration from two group sessions/week to one. The clinical report stated Plaintiff is 'fixated on his lawsuits, and often talks about his lawsuits during group sessions,' while simultaneously acknowledging active participation and demonstrated mastery. Juszczak (individual clinician, also trainee under Palacios) contributed supporting clinical determinations. Palacios — named defendant in Plaintiff's existing lawsuits — reviewed, approved, and ratified the retaliatory report. HOPE's billing generates ~$10,600/year per parolee at two groups/week; titration would halve that revenue. Trainee vulnerability: Palacios holds power to withhold licensure hour signatures, creating 'supervisory contagion' where trainees mirror supervisor's retaliatory biases.",
      procedural_status: "Filed 03/16/2026. Unlimited civil jurisdiction. Jury trial demanded.",
      damages: "$200,000 - $500,000+", risk: "Clinical discretion defense; report's explicit 'fixation on lawsuits' language constitutes direct evidence removing decision from protected clinical judgment. Prof. negligence may require CCP §411.35 expert declaration. No gov. claim needed — private defendants.",
      evidence: ["Feb. 18, 2026 CTM Report", "HOPE Session Recordings", "Prior CTM records ('ringleader')", "Dwyer order", "HOPE billing model", "BBS supervisory regs", "FedEx records", "CDL wage docs"]
    },
    {
      number: 17, caption: "Newanforbi v. Moua et al.", case_no: "TBD (San Joaquin Sup. Ct.)", court: "San Joaquin Sup. Ct.",
      claims: "Mandatory Duty Breach, False Imprisonment, IIED, Econ. Interference", status: "Filed 03/31/2026",
      filed: "March 31, 2026", judge: "TBD", cluster: 2, type: "State",
      ...
      procedural_status: "Filed 03/31/2026. Gov. claim deemed rejected 03/27/2026 (§912.4(c)). Jury trial demanded.",
    ...
    {
      number: 18, caption: "Newanforbi v. Urrea et al.", case_no: "TBD (San Joaquin Sup. Ct.)", court: "San Joaquin Sup. Ct.",
      claims: "False Imprisonment, Bane Act, IIED, Negligent Supervision", status: "Complaint ready; filing imminent",
      filed: "Complaint ready (March 2026)", judge: "TBD", cluster: 2, type: "State",
  ...
  timeline: [
    ...
    { date: "Mid-2025", event: "Palacios labels Plaintiff 'ringleader'", matters: "4,5,16", type: "event" },
    ...
    { date: "Feb. 10, 2026", event: "Gov. tort claim filed for Moua discharge review", matters: "17", type: "filing" },
    { date: "Feb. 10, 2026", event: "HOPE/Palacios state tort filed", matters: "8", type: "filing" },
    ...
    { date: "Feb. 18, 2026", event: "CTM: Doe denies titration citing 'fixation on lawsuits'; Palacios ratifies", matters: "16", type: "event" },
    { date: "Mar. 2, 2026", event: "Federal Policy 19-03 challenge filed", matters: "15", type: "filing" },
    { date: "Mar. 2, 2026", event: "Gov. Claim mailed for Policy 19-03 state tort", matters: "10", type: "filing" },
    { date: "Mar. 3, 2026", event: "Fee Waiver Hearing, Alameda (Hayward)", matters: "2", type: "hearing", upcoming: true },
    { date: "Mar. 16, 2026", event: "HOPE clinical retaliation complaint filed (Bane Act, Prof. Negligence, IIED)", matters: "16", type: "filing" },
    { date: "Mar. 27, 2026", event: "Gov. claim deemed rejected (§912.4(c)) for Moua tort", matters: "17", type: "event" },
    { date: "Mar. 27, 2026", event: "Mandamus Hearing, Sacramento, Dept. 32", matters: "3", type: "hearing", upcoming: true },
    { date: "Mar. 31, 2026", event: "Moua et al. state tort filed ($109,408 documented lost wages)", matters: "17", type: "filing" },
    { date: "Apr. 20, 2026", event: "State tort filing planned (Policy 19-03)", matters: "10", type: "filing", upcoming: true },
    { date: "Jul. 6, 2026", event: "CMC, Alameda (Hayward)", matters: "2", type: "hearing", upcoming: true },
    { date: "Aug. 12, 2026", event: "CMC, San Joaquin", matters: "9", type: "hearing", upcoming: true },
    { date: "Oct. 13, 2026", event: "CMC, San Joaquin", matters: "8", type: "hearing", upcoming: true }
  ],
  theories: [
    { id: 1, title: "First Amendment Retaliation as the Catalyst", matters: "4,5", icon: "🗣️", desc: "Derrick's 'no freedom of speech' statement triggered the cascade. Satisfies Rhodes v. Robinson chilling effect test." },
    { id: 2, title: "HOPE Program Structural Incentive Misalignment", matters: "7,8", icon: "💰", desc: "Fee-for-service billing (~$9,690/yr per parolee) with no completion bonus creates perverse retention incentive. Condemned in Dwyer and Macomber." },
    { id: 3, title: "Race-Based Disparate Treatment", matters: "4,5", icon: "⚖️", desc: "Sworn declarations from white comparator (favorable treatment) and Black parolee (hostile treatment) under same agent. CHP encounter adds additional dimension." },
